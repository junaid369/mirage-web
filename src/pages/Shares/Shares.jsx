    ...
    <div className="mt-24">
      ...
      <section className="detailDescrption max-sm:mx-5  lg:mx-32 mb-16">
        <div className="contents">
          <h1 className="text-sm font-thin py-1">ABOUT SHARES CFDS</h1>
          <h1 className="text-3xl     font-serif py-1">
            What are shares CFDs?
          </h1>
          <p className="descrption py-1 text-md">
            CFDs on shares (also known as CFD stock trading) are contracts that
            allow traders to speculate on the rise or fall of a company’s share
            price with leverage - without owning any shares directly. “CFDs” are
            a short way of saying “Contract for Differences” and they are a
            popular choice for traders looking to speculate on the rise and fall
            of the share prices (i.e., prices that move a lot). Shares are also
